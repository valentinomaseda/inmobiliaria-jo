  ...
  return (
    ...
    >
      ...
      <Link to={`/propiedad/${propiedad.id}`} className="relative aspect-[4/3] w-full overflow-hidden bg-gray-100 block">
        ...
        {propiedad.destacada && (
          <div className="absolute top-4 right-4 z-10 bg-gradient-to-r from-jo-pink to-pink-500 text-white px-3 py-1.5 rounded-full text-xs font-bold tracking-wide shadow-lg flex items-center gap-1">
